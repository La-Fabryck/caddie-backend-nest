...
export default defineConfig({
  ...
  rules: {
    ...
    // --- Intentionally off (Nest / project) ---
    // emitDecoratorMetadata: constructor-injected services and @Body() DTOs need value imports.
    // Services may still use `import type` for DTOs. https://github.com/oxc-project/oxc/issues/13609
  ...
  overrides: [
    // typescript-eslint `eslint-recommended` compatibility (kept by @oxlint/migrate):
